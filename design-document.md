...
本アプリは、複数の選択肢から何かを選びたいが、何を基準に決めればよいか整理できていない人を対象とする。

| 項目 | 内容 |
|---|---|
| 年齢 | 18～30歳程度 |
| 主な利用者 | 大学生、若手社会人 |
| 利用目的 | 買い物、アルバイト、旅行、進路などの選択 |
| 困っていること | 選択肢はあるが、何を重視して比較すればよいか分からない |
| 操作面の希望 | 長い文章を入力するより、ボタンを押して簡単に回答したい |
